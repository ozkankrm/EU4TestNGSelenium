...
public class ExtentDemoTest {
    ...
    public void setUp(){
        ...
        //initialize the html reporter with the reporter path
    ...
    @Test
    public void test1(){
        //give name to current test  ( bu satırı hatırla çok kullanacaksın)
    ...
    public void teardown(){
        ...
        //İlgili rapordaki önceki verileri siler ve tamamen yeni bir rapor oluşturur.
        report.flush();
    }
}
